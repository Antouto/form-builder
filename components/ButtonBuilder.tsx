...
//@ts-expect-error
export default function ButtonBuilder({ register, fix, setValue, watch, forButton, error, button }) {
  ...
  return (
    <>
      <Box width={isSmallScreen ? '100%' : '50%'}>
        <FormLabel htmlFor={`${forButton}.label`} display='flex' alignItems='flex-end'><Text _after={{ content: '" *"', color: (colorMode === 'dark' ? '#ff7a6b' : '#d92f2f') }}>Button Label</Text>
