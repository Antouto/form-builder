...
import { ChannelIcon, ForwardIcon, ReplyIcon, ThreadIcon } from "./Icons";
...
export function Editor({
              ...
              >
                <HStack>
                  ...
                  <Tooltip
                    ...
                    bg="#181414"
                  >
    <a href="https://forms.lemonsqueezy.com/buy/6c238e6d-28f7-44ea-b965-b2f8c9e2512b" target="_blank"><svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M9.53722 22.0062C9.272 22.0062 9.01765 22.1116 8.83011 22.2991C8.64258 22.4866 8.53722 22.741 8.53722 23.0062C8.53722 23.8019 8.85329 24.5649 9.4159 25.1275C9.97851 25.6901 10.7416 26.0062 11.5372 26.0062H21.5372C22.3329 26.0062 23.0959 25.6901 23.6585 25.1275C24.2211 24.5649 24.5372 23.8019 24.5372 23.0062C24.5372 22.741 24.4319 22.4866 24.2443 22.2991C24.0568 22.1116 23.8024 22.0062 23.5372 22.0062H9.53722ZM7.57722 11.7662C7.40388 11.6437 7.19605 11.5795 6.98381 11.5829C6.77157 11.5864 6.56593 11.6573 6.39665 11.7853C6.22737 11.9134 6.10323 12.092 6.04221 12.2953C5.98119 12.4986 5.98645 12.7161 6.05722 12.9162L8.30722 19.3362C8.37543 19.5314 8.50245 19.7006 8.67078 19.8205C8.83912 19.9405 9.0405 20.0054 9.24722 20.0062H23.7972C24.0106 20.0047 24.2179 19.935 24.3888 19.8073C24.5598 19.6795 24.6853 19.5004 24.7472 19.2962L26.6872 12.8462C26.7496 12.6449 26.7469 12.429 26.6793 12.2294C26.6117 12.0297 26.4827 11.8565 26.3108 11.7345C26.1389 11.6125 25.9329 11.548 25.7221 11.5501C25.5114 11.5522 25.3066 11.6208 25.1372 11.7462L21.0272 14.7462L17.4772 9.41622L18.2972 8.59622C18.3752 8.51904 18.4371 8.42715 18.4794 8.32588C18.5217 8.2246 18.5434 8.11596 18.5434 8.00622C18.5434 7.89648 18.5217 7.78783 18.4794 7.68656C18.4371 7.58529 18.3752 7.4934 18.2972 7.41622L17.1272 6.24622C17.05 6.16821 16.9581 6.10629 16.8569 6.06402C16.7556 6.02176 16.647 6 16.5372 6C16.4275 6 16.3188 6.02176 16.2176 6.06402C16.1163 6.10629 16.0244 6.16821 15.9472 6.24622L14.7772 7.41622C14.6992 7.4934 14.6373 7.58529 14.595 7.68656C14.5528 7.78783 14.531 7.89648 14.531 8.00622C14.531 8.11596 14.5528 8.2246 14.595 8.32588C14.6373 8.42715 14.6992 8.51904 14.7772 8.59622L15.5972 9.41622L11.9872 14.8362L7.57722 11.7662Z" fill="#B5BCFC" />
    </svg></a>
                  </Tooltip>
                </HStack>
                <Link
          ...
          <>
            ...
            <VStack align="center" mt={5} width="100%" gap={5}>
              <Box width="100%" maxWidth="500px">
                ...
                {/* <VStack>
                  <HStack justifyContent='space-between' maxWidth="300px" width="100%">
                    <HStack>
                    <img style={{ borderRadius: '50%' }} width="40px" src="https://cdn.discordapp.com/embed/avatars/0.png" alt="" />
                  ...
                  <HStack justifyContent='space-between' maxWidth="300px" width="100%">
                  <HStack>
                  <svg width="40px" height="40px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 88">
  ...
  <path d="M 12,34 V 63 H 52 V 34 Z M 29.5,58 H 17 v -7 h 12.5 z m 0,-12 H 17 V 39 H 29.5 Z M 47,58 H 34.5 V 51 H 47 Z M 47,46 H 34.5 V 39 H 47 Z" fill="#fff"/>
      ...
      <Modal isOpen={isOpenPremium} onClose={onClosePremium}>
        <ModalOverlay />
        <ModalContent bg="grey.dark">
          <ModalHeader>    <HStack><a href="https://forms.lemonsqueezy.com/buy/6c238e6d-28f7-44ea-b965-b2f8c9e2512b" target="_blank"><svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="16" cy="16" r="16" fill="#5865F2" fill-opacity="0.4" />
      <path d="M9.53722 22.0062C9.272 22.0062 9.01765 22.1116 8.83011 22.2991C8.64258 22.4866 8.53722 22.741 8.53722 23.0062C8.53722 23.8019 8.85329 24.5649 9.4159 25.1275C9.97851 25.6901 10.7416 26.0062 11.5372 26.0062H21.5372C22.3329 26.0062 23.0959 25.6901 23.6585 25.1275C24.2211 24.5649 24.5372 23.8019 24.5372 23.0062C24.5372 22.741 24.4319 22.4866 24.2443 22.2991C24.0568 22.1116 23.8024 22.0062 23.5372 22.0062H9.53722ZM7.57722 11.7662C7.40388 11.6437 7.19605 11.5795 6.98381 11.5829C6.77157 11.5864 6.56593 11.6573 6.39665 11.7853C6.22737 11.9134 6.10323 12.092 6.04221 12.2953C5.98119 12.4986 5.98645 12.7161 6.05722 12.9162L8.30722 19.3362C8.37543 19.5314 8.50245 19.7006 8.67078 19.8205C8.83912 19.9405 9.0405 20.0054 9.24722 20.0062H23.7972C24.0106 20.0047 24.2179 19.935 24.3888 19.8073C24.5598 19.6795 24.6853 19.5004 24.7472 19.2962L26.6872 12.8462C26.7496 12.6449 26.7469 12.429 26.6793 12.2294C26.6117 12.0297 26.4827 11.8565 26.3108 11.7345C26.1389 11.6125 25.9329 11.548 25.7221 11.5501C25.5114 11.5522 25.3066 11.6208 25.1372 11.7462L21.0272 14.7462L17.4772 9.41622L18.2972 8.59622C18.3752 8.51904 18.4371 8.42715 18.4794 8.32588C18.5217 8.2246 18.5434 8.11596 18.5434 8.00622C18.5434 7.89648 18.5217 7.78783 18.4794 7.68656C18.4371 7.58529 18.3752 7.4934 18.2972 7.41622L17.1272 6.24622C17.05 6.16821 16.9581 6.10629 16.8569 6.06402C16.7556 6.02176 16.647 6 16.5372 6C16.4275 6 16.3188 6.02176 16.2176 6.06402C16.1163 6.10629 16.0244 6.16821 15.9472 6.24622L14.7772 7.41622C14.6992 7.4934 14.6373 7.58529 14.595 7.68656C14.5528 7.78783 14.531 7.89648 14.531 8.00622C14.531 8.11596 14.5528 8.2246 14.595 8.32588C14.6373 8.42715 14.6992 8.51904 14.7772 8.59622L15.5972 9.41622L11.9872 14.8362L7.57722 11.7662Z" fill="#B5BCFC" />
    </svg></a><Text>You've discovered a premium feature!</Text></HStack></ModalHeader>
          <ModalCloseButton />
          <ModalBody pt={5} fontSize="18px" fontWeight="600">
            <VStack gap={4} align="flex-start">
              <Text fontWeight="400">Premium Features</Text>
              <HStack>
                <Image src="sheets.png" alt="" width='32px' height='32px' />
                <Text
                  className={
                    premiumFeatureTarget === "google_sheets"
                      ? "highlighted-feature"
                      : ""
                  }
                >
