  ...
  return (
    <>
      <Box width={isSmallScreen ? '100%' : '50%'}>
        <FormLabel htmlFor={`${forButton}.label`} display='flex' alignItems='flex-end'><Text _after={buttonLabelRequired === 'no' ? 'unset' : { content: '" *"', color: (colorMode === 'dark' ? '#ff7a6b' : '#d92f2f') }}>{buttonLabel || 'Button Label'}</Text>
      ...
      <Box>
        <FormLabel htmlFor={`${forButton}.style`}>
          <Text _after={buttonColourRequired === 'no' ? 'unset' : { content: '" *"', color: (colorMode === 'dark' ? '#ff7a6b' : '#d92f2f') }}>{buttonColour || 'Button Colour'}</Text>
        </FormLabel>
        <HStack>
          <Button height='36px' width='36px' minWidth={'unset'} padding={0} _hover={{ background: 'blurple' }} background={'blurple'} onClick={() => { allowColourDeselect ? (getValues(`${forButton}.style`) === 1 ? setValue(`${forButton}.style`, undefined) : setValue(`${forButton}.style`, 1)) : setValue(`${forButton}.style`, 1)}}>{watch(`${forButton}.style`) === 1 && <svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill="white" d="M21.7 5.3a1 1 0 0 1 0 1.4l-12 12a1 1 0 0 1-1.4 0l-6-6a1 1 0 1 1 1.4-1.4L9 16.58l11.3-11.3a1 1 0 0 1 1.4 0Z"></path></svg>}</Button>
          <Button height='36px' width='36px' minWidth={'unset'} padding={0} _hover={{ background: 'grey.light' }} background={'grey.light'} onClick={() => { allowColourDeselect ? (getValues(`${forButton}.style`) === 2 ? setValue(`${forButton}.style`, undefined) : setValue(`${forButton}.style`, 2)) : setValue(`${forButton}.style`, 2)}}>{watch(`${forButton}.style`) === 2 && <svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill="white" d="M21.7 5.3a1 1 0 0 1 0 1.4l-12 12a1 1 0 0 1-1.4 0l-6-6a1 1 0 1 1 1.4-1.4L9 16.58l11.3-11.3a1 1 0 0 1 1.4 0Z"></path></svg>}</Button>
          <Button height='36px' width='36px' minWidth={'unset'} padding={0} _hover={{ background: 'green' }} background={'green'} onClick={() => { allowColourDeselect ? (getValues(`${forButton}.style`) === 3 ? setValue(`${forButton}.style`, undefined) : setValue(`${forButton}.style`, 3)) : setValue(`${forButton}.style`, 3)}}>{watch(`${forButton}.style`) === 3 && <svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill="white" d="M21.7 5.3a1 1 0 0 1 0 1.4l-12 12a1 1 0 0 1-1.4 0l-6-6a1 1 0 1 1 1.4-1.4L9 16.58l11.3-11.3a1 1 0 0 1 1.4 0Z"></path></svg>}</Button>
          <Button height='36px' width='36px' minWidth={'unset'} padding={0} _hover={{ background: 'red' }} background={'red'} onClick={() => { allowColourDeselect ? (getValues(`${forButton}.style`) === 4 ? setValue(`${forButton}.style`, undefined) : setValue(`${forButton}.style`, 4)) : setValue(`${forButton}.style`, 4)}}>{watch(`${forButton}.style`) === 4 && <svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill="white" d="M21.7 5.3a1 1 0 0 1 0 1.4l-12 12a1 1 0 0 1-1.4 0l-6-6a1 1 0 1 1 1.4-1.4L9 16.58l11.3-11.3a1 1 0 0 1 1.4 0Z"></path></svg>}</Button>
        </HStack>
      </Box>
    </>
  )
