export async function onRequest({ request, env }) {
  ...
  try {
    ...
    const cookieHeader = `session=${sessionID}; Secure; Domain=discordforms.app; Path=/; Max-Age=${expires_in}; SameSite=Lax`;
...
`, {
      ...
      headers: {
        ...
        // 'Location': 'https://create.discordforms.app',  // Redirect to a page after login
      },
    });
