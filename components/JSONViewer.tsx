  ...
  return (
    <Box
      style={{
        ...
        borderRadius: "4px",
        background: colorMode === "dark" ? "#2f3136" : "#f2f3f5",
        color: colorMode === "dark" ? "#e0e1e5" : "#4f5660",
        width: "100%",
      }}
    >
      <Collapse
        ...
        style={{
          overflow: "scroll",
          backgroundColor: colorMode == "dark" ? "#2f3136" : "#f2f3f5",
          borderRadius: "4px",
          padding: "8px",
          fontSize: "14px",
        }}
      ...
      <Box
        ...
        borderTop={`1px solid ${colorMode === "dark" ? "#292b2f" : "#e3e5e8"}`}
        color="#b8b9bf"
      >
        <Box
          display="flex"
        ...
        <HStack>
          {
            <Tooltip
              hasArrow
              label="Form Configuration File"
              placement="top"
              bg="#181414"
            >
              <Text _hover={{ color: "#e0e1e5" }}>{fileName}</Text>
            </Tooltip>
          }
